  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Pass-Out  Request</h1>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-lg-12">
           <div class="card-header">
            <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Pass-Out Request</h3>
                </div>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="datetime-local" class="form-control" value="{{ old('time_out')}}" name="time_out" id="time_out" required>
                    </div>

                      <div class="form-group">
                        <label for="exampleInputEmail1"> Reason </label>
                    <textarea class="form-control" value="{{ old('reason')}}" name="reason" id="exampleFormControlTextarea1" rows="3"></textarea>
                  ...
                  <div class="card-footer">
                    <a href="{{url('passout/list')}}" class="btn btn-danger"><i class="fa-solid fas fa-reply mr-2"></i>Back</a>
