  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Assign Machine</h1>
          </div><!-- /.col -->
                    ...
                    <div class="form-group">
                      ...
                      <span style="color:red;">*</span>
                        ...
                        @foreach($getAssignSubjectID as $subjectAssign)
                              ...
                              @if($subjectAssign->subject_id == $subjects->id)
                                    @php
                                    $checked ="checked";
                                    @endphp
                                @endif
                      ...
                      <input {{ $checked }} type="checkbox" value="{{$subjects->id}}" name="subjects_id[]"> {{$subjects->name}} {{$subjects->subject_code}}
                      </label>
                      </div>
                        @endforeach
