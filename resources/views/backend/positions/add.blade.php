                ...
                <form action="" method="post">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="{{ old('name')}}" name="name"  placeholder="Enter Position Name">
                    </div>
                    <span style="color:red;">{{$errors->first('name')}}</span>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Description </label>
                        
                        <textarea class="form-control" value="{{ old('notes')}}" name="notes" roow="6" placeholder="Enter Description"></textarea>
                      </div>
                      <span style="color:red;">{{$errors->first('notes')}}</span>
                      <div class="form-group">
                      <label for="exampleInputEmail1">Gazette Rate</label>
                      <span style="color:red;">*</span>
                      <input type="text" class="form-control" value="{{ old('gazett_rate')}}" name="gazett_rate"  placeholder="Enter Gazette Rate">
                    </div>
