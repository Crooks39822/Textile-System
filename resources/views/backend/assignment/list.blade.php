      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align:right;">
            <a href="{{url('admin/assignment/add')}}" class="btn btn-primary mb-2">Add New Assignment</a>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
            ...
            <form method="get" action="">
                <div class="card-body">
                    <div class="row">
                       ...
                       <a href="{{url('admin/assignment/assignment')}}" class="btn btn-success" style="margin-top: 30px">Clear</a>
                        </div>
...
<table class="table table-hover text-nowrap">
                    ...
                    <tr>
                      ...
                      <td style="min-width: 300px">
                          ...
                          <a href="{{url('admin/assignment/edit/'.$value->id)}}" class="btn btn-primary">Edit</a>
                          <a href="{{url('admin/assignment/delete/'.$value->id)}}" class="btn btn-danger">Delete</a>
                          <a href="{{url('admin/assignment/submitted/'.$value->id)}}" class="btn btn-success">Submitted </a>
                      </td>
                    </tr>
                    @empty
