  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Student Submitted Assignment <span style="color:blue"> ({{  $getStudent->name }} - {{  $getStudent->last_name }}) </span> </h1>
          </div><!-- /.col -->
        ...
        <div class="row">
          ...
          <div class="card">
           <div class="card-header">
            ...
            <h3 class="card-title">Search Student Submitted Assignment </h3>
        </div>
            <form method="get" action="">
                <div class="card-body">
                    <div class="row">
                       ...
                       <a href="{{url('parent/my_student/submitted_assignment/'.$getStudent->id)}}" class="btn btn-success" style="margin-top: 30px">Clear</a>
                        </div>
           ...
           <div class="card">
            ...
            <h3 class="card-title">Student Submitted Assignment List</h3>
            </div>
