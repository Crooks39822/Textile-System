  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>My Exam Result:  <span style="color:blue">({{$getStudent->name}} {{$getStudent->last_name}})  </h1>
          </div>
      ...
      <div class="container-fluid">
        <div class="row">
           ...
           <div class="card">
            ...
            <a class="btn btn-primary" target="_blank" style="float:right;"
                                href="{{url('parent/my_exam_result/print?exam_id='.$value['exam_id'].'&student_id='
              .$getStudent->id)}}">Print </a>
              @else
