...
@section('content')
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>My Attendance <span style="color:blue"> ({{  $getStudent->name }} - {{  $getStudent->last_name }}) </span> (Total: {{$getRecord->total()}})</span></h1>
          </div>
        </div>
      </div>
    </div>
                    ...
                    <form method="get" action="">
                        <div class="card-body">
                            <div class="row">
                               ...
                               <a href="{{url('parent/myStudents')}}" class="btn btn-success" style="margin-top: 30px">Clear</a>
                                </div>
