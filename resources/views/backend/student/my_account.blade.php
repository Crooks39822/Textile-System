                ...
                <form action="" method="post"  enctype="multipart/form-data">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <span style="color:red;">*</span>
                      <input type="date" readonly class="form-control" value="{{ old('date_of_birth',$getRecord->date_of_birth)}}" name="date_of_birth">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <span style="color:red;">*</span>
                      <input type="number" readonly class="form-control" value="{{ old('age',$getRecord->age)}}" name="age" placeholder="Enter Age">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <span style="color:red;">*</span>
                      <input type="text" readonly class="form-control" value="{{ old('id_number',$getRecord->id_number)}}" name="id_number" placeholder="Enter ID Number">
