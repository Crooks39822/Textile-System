  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Leave Type (Total: {{$getRecord->total()}}) </h1>
          </div><!-- /.col -->
          <div class="col-sm-6" style="text-align:right;">
            <a href="{{url('admin/leave/type/add')}}" class="btn btn-primary mb-2">Add New Leave Type</a>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="row">
          <div class="col-md-12">
           ...
           <div class="card-header">
            ...
            <h3 class="card-title">Search Leave Type </h3>
        </div>
            <form method="get" action="">
                <div class="card-body">
                    <div class="row">
                       ...
                       <a href="{{url('admin/leave/types')}}" class="btn btn-success" style="margin-top: 30px">Clear</a>
                        </div>
