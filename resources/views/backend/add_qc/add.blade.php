                ...
                <form action="" method="post"  enctype="multipart/form-data">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <span style="color:red;"></span>
                      <input type="text" class="form-control" value="{{ old('roll_number')}}" name="roll_number" placeholder="Enter Next of Kin">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <span style="color:red;">*</span>
                      <input type="text" class="form-control" value="{{ old('id_number')}}" name="id_number" placeholder="Enter ID Number (13 Digits)">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <span style="color:red;">*</span>
                      <input type="text" class="form-control" value="{{ old('previous_school')}}" name="previous_school" placeholder="Enter Previous School ">
                    ...
                    <div class="form-group col-md-6">
                      <label for="exampleInputFile">QC Photo</label>
                  ...
                  <div class="card-footer">
                    <a href="{{url('admin/qc')}}" class="btn btn-danger"><i class="fa-solid fas fa-reply mr-2"></i>Back</a>
