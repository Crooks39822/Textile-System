          ...
          <div class="col-lg-12">
           <div class="card-header">
            <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Edit QC</h3>
                </div>
...
@if(Auth::user()->parent_id == 2)
                    ...
                    <div class="form-group col-md-6">
                      <label for="exampleInputEmail1">Rate per Hour</label>
                      <span style="color:red;"></span>
                      <input type="text" class="form-control" value="{{ old('roll_number',$getRecord->roll_number)}}" name="roll_number" readonly>
                      <span style="color:red;">{{$errors->first('roll_number')}}</span>
                    </div>
                    @endif
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <span style="color:red;">*</span>
                      <input type="date" class="form-control" id="dob" value="{{ old('date_of_birth',$getRecord->date_of_birth)}}" name="date_of_birth">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <span style="color:red;">*</span>
                      <input type="number" class="form-control" value="{{ old('age',$getRecord->age)}}" id="age" name="age"readonly>
