  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Disciplinary Action Edit</h1>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-lg-12">
           <div class="card-header">
            <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Disciplinary Action Edit</h3>
                </div>
                  ...
                  <div class="card-body">
                    ...
                    <!-- <div class="form-group">
                      ...
                      <select class="form-control" name="actiontype" required>
                        ...
                        <option  {{(old('actiontype',$getRecord->actiontype) == $types->id) ? 'selected' : ''}}  value="{{$types->id}}">{{$types->name}}</option>
                        @endforeach
                        </select>
